    ...
    <div className="flex flex-col gap-4 w-full bg-[#161721] relative py-4 bg-gradient-to-r from-[#2C2C2D] to-[#1D222C]">
      <div className="relative z-20 flex flex-row justify-between w-full px-2 sm:px-8">
        ...
        <div className="main_title">
          <div className="title_h1" style={{ "textShadow": "4px 4px 2px rgba(1,1,1,.72)" }}>FAQ</div>
        </div>
        <button
          className="pl-4"
          onClick={() => {
      ...
      <Menu as="div" className="relative inline-block text-left mx-auto">
        <div>
          <Menu.Button className="inline-flex justify-center gap-x-1.5 border-2 border-solid border-[#FEB600] hover:border-[#9e8130] rounded-lg font-open-sans text-lg text-white w-[300px] uppercase relative py-4 bg-[#161721]">
            {FAQItem[selection]}
            <ChevronDownIcon
                ...
                return (
                  <Menu.Item key={index}>
                    <div
                      ...
                      onClick={() => { setSelectedFaqItem(index); setSelection(index)} }
                    >
                      {item}
                    </div>
                  </Menu.Item>
